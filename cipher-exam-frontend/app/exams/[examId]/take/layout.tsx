// layout.tsx - Server component for take route
...
export function generateStaticParams() {
  ...
  // This ensures take pages are generated for each examId
  return [
    { examId: '0' },
    { examId: '1' },
    { examId: '2' },
...
export default async function TakeLayout({ children, params }: Props) {
